...
; Addition Test
(test (constant-folding  (parse '{+ 2 3} ) ) (parse '5))
(test (constant-folding (parse '{+ 1 2 3 4 5})) (parse '15)) 


; Subtraction Test
(test (constant-folding (parse '{- 10 2} )) (parse '8))
(test (constant-folding (parse '{- 20 5 3 2 2})) (parse '8))



; Multiplication Test
(test (constant-folding (parse '{* 4 5}) ) (parse '20))
(test (constant-folding (parse '{* 2 3 4 5})) (parse '120))


; Division Test
(test (constant-folding (parse '{/ 15 3}) ) (parse '5))
(test (constant-folding (parse '{/ 100 2 2 2})) (parse '25/4))


; mixed operations
(test (constant-folding (parse '{+ 1 2 {* 4 5} {- 10 5} {/ 36 6}})) (parse '13))

; Greater Than Test
(test (constant-folding (parse '{> 5 2}) ) (parse '#t))
