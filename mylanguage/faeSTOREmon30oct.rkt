...
(define (interp expr env sto)
  (match expr
    ...
    [(sub l r)
     ; 1. evaluar l
     (define (v*s l-val l-sto) (interp l env sto))
     ;2 evaluar r
     (define (v*s r-val r-sto) (interp r env l-sto))
    ...
    [(app f e)
     ...
     ; 2 interp e
     (def (v*s arg-val arg-sto) (interp e env sto fun-sto))
